...
var data = [
    ...
    "In the twenty fourteen fifteen season, Leicester City spent longer at the bottom of the table without being relegated than any side in Premier League history.They were bottom for hundred and forty days.",
    "Peter Crouch has scored fifty headed goals,which is more than sixteen of the teams who have played in the Premier League.",
    "Former Liverpool player, Nuri Sahin, has played the most Premier League games of any player to be substituted off in all of their PL appearances.He played 7 Premier League games.",
    "Former Liverpool player,Iago Aspas took more corners than he had shots in the Premier League.",
    "In the nineteen ninety seven ninety eight season, Andy Roberts played 37 games in the Premier League and four of them came against Arsenal.Two for Palace, two for Wimbledon.",
    ...
    "Manchester United have won the Premier League title a record thirteen times, followed by Chelsea 5 times, Arsenal thrice, Manchester City twice, and Leister and Blackburn once.",
    ...
    "The Premier League is the most watched sports league in the world, broadcast in two twelve territories to six forty three million homes and a potential TV audience of four point seven billion people.",
    ...
    "Arsenal hold the record of twenty consecutive finishes in the top four, until the twenty sixteen seventeen season when they finished fifth.",
    ...
    "Theory Onry holds the record for the most goals scored per match in the Premier League,which is point six eight.",
    ...
    "Ryan Giggs holds the record for the most appearances in the Premier League, with six thrity two.",
    ...
    "Manchester United hold the record for the most consecutive title wins,which is three.They've achieved the feat twice, once in seasons ninety eight ninety nine,ninety nine two thousand,two thousand two thousand one.And again in O six O seven, O seven O eight, O eight O nine.",
    ...
    "Cheslea hold the record for the most away wins in a season.They won fifteen away games in the twenty O five O six season.",
    ...
    "The record for the most wins in a single season is thirteen and has been achieved twice in Premier League history.Arsenal in two thousand O two O three season and Chelsea in the twenty sixteen seventeen season.",
    "Derby County went the longest without a recording a win in Premier League.They couldnt register a win for thirty two consecutive games in the two thousand seven O eight season.",
    ...
    "Chelsea hold the record for the most consecutive away wins.The team won eleven straight away games between sixth April two thousand O eight and seventh December two thousand O eight.",
    "Arsenal hold the record for the longest unbeaten in the Premier League.The team went forty nine games unbeaten between seventh May two thousand O three and twenty fourth October two thousand O four.",
    "Arsenal hold the record for the fewest away losses in a season.They didnt lose a single away game in two thousand one O two thousand two season as well as the two thousand three two thousand four season.",
    "Chelsea accumulated the most points in a Premier League season,when they won the title in two thousand O four O five season with ninety five points.",
    "The oldest player to appear in a Premier League match is John Burridge, at forty three years and hundred and sixty two days, for Manchester City against Queens Park Rnagers on fourtheenth May nineteen ninety five.",
